...
annotation_path = "../data/dataset/train_box.txt"
circuit_anchors_path = "../data/anchors/circuit_anchors.txt"
...
def kmeans(boxes, k, dist=np.median):
    ...
    return clusters, nearest_clusters, boxes
...
def get_kmeans(anno, cluster_num=9):
    ...
    anchors,nearest_clusters, boxes = kmeans(anno, cluster_num)
    ...
    return anchors, ave_iou, nearest_clusters, boxes
...
if __name__ == '__main__':
    ...
    anchors, ave_iou, nearest_clusters, boxes = get_kmeans(anno_result, 9)

    with open('boxes.txt', 'wb') as boxes_f:
        pickle.dump(boxes, boxes_f)

    with open('nearest_clusters.txt', 'wb') as nearest_clusters_f:
        pickle.dump(nearest_clusters, nearest_clusters_f)

    with open('get_anchors.txt', 'wb') as anchors_f:
        pickle.dump(anchors, anchors_f)

    with open(circuit_anchors_path, 'w') as file:
        anchor_string = ''
